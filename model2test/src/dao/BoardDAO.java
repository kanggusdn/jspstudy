...
//			close(pstmt);
	...
	public boolean isArticleBoardWriter(int board_num, String pass) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String board_sql = "select board_pass from board where board_num=?"; // 보안상 패스워드만 가져오는 것이 좋음.
		...
		try {
			...
			if (pass.equals(rs.getString("board_pass"))) { // 괄호 안에 1을 적어도 됨.
				isWriter = true;
			}
		} catch (SQLException ex) {
	...
	public int delteArticle(int board_num) {
		PreparedStatement pstmt = null;
