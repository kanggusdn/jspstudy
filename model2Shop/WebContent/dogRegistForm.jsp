		...
		<form action="dogRegist.do" method="post" name="writeForm" enctype="multipart/form-data">
			<table>
				...
				<tr>
					...
					<td class="td_right"><textarea rows="13" cols="40" id="content" name="content" wrap="off"></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" id="commandCell">
						...
						<input type="button" value="개상품목록보기" onclick="location.href='dogList.do'" />
					</td>
				</tr>
			</table>
		</form>
